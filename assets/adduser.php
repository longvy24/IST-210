...
<div id="wrapper"> <a href="../assets/Logo.jpg"><img src="../assets/Logo.jpg" alt="logo" name="logo" width="960" height="250" id="logo" /></a>
		...
		echo '<br />';
		echo '<br />';
        echo $fname . ", " . $lname . ", " . $address . ", " .$city . ", " .$zip . ", " .$email . ", " .$salary . '<br />';
    ...
    //    echo $fname . " " . $lname . " " . $address . '<br />';
        ...
        $query = "INSERT INTO faculty (fname, lname, address, city, zip, email, salary) VALUES ($fname,$lname,$address, $city, $zip, $email, $salary)";
