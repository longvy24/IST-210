...
if (isset($_POST['Submit'])){
	...
	//	echo "<br />";		
		...
		if ($result = true)
		{
			echo "Your Information has been successfully updated unless info was input wrong.<br/> Data won't change but you will still see this message because reasons. <br/> <br/>";
			$result="update faculty set city='$newcity' where fname='$fname' and city='$oldCity'";
